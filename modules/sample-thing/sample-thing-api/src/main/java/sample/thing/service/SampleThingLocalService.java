...
/**
 * Provides the local service interface for SampleThing. Methods of this
 * service will not have security checks based on the propagated JAAS
 * credentials because this service can only be accessed from within the same
 * VM.
 *
 * @author Brian Wing Shun Chan
 * @see SampleThingLocalServiceUtil
...
public interface SampleThingLocalService extends BaseLocalService,
	PersistedModelLocalService {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. Always use {@link SampleThingLocalServiceUtil} to access the sample thing local service. Add custom service methods to {@link sample.thing.service.impl.SampleThingLocalServiceImpl} and rerun ServiceBuilder to automatically copy the method declarations to this interface.
	 */
	...
	*/
	...
	public SampleThing addSampleThing(SampleThing sampleThing);
	...
	*/
	public SampleThing createSampleThing(long sampleId);
	...
	*/
	...
	public SampleThing deleteSampleThing(long sampleId)
		throws PortalException;
	...
	*/
	@Indexable(type = IndexableType.DELETE)
	public SampleThing deleteSampleThing(SampleThing sampleThing);
	...
	*/
	...
	public SampleThing fetchSampleThing(long sampleId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SampleThing fetchSampleThingByUuidAndGroupId(java.lang.String uuid,
		long groupId);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SampleThing getSampleThing(long sampleId) throws PortalException;
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public SampleThing getSampleThingByUuidAndGroupId(java.lang.String uuid,
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SampleThing> getSampleThings(int start, int end);
	...
	*/
	@Transactional(propagation = Propagation.SUPPORTS, readOnly = true)
	public List<SampleThing> getSampleThingsByUuidAndCompanyId(
	...
	*/
	@Indexable(type = IndexableType.REINDEX)
	public SampleThing updateSampleThing(SampleThing sampleThing);
}